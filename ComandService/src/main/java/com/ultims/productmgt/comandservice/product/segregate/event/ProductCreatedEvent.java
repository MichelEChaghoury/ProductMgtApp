package com.ultims.productmgt.comandservice.product.segregate.event;
...
public class ProductCreatedEvent {
    ...
    public ProductCreatedEvent(UUID id, String name, String description, BigDecimal quantity, BigDecimal unitPrice) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "ProductCreatedEvent{" + "id=" + id +
                ", name='" + name + '\'' +
